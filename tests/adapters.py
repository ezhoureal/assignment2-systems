...
from cs336_systems.ddp import DDPWrapper
from cs336_systems.flash_attention import FlashAttentionPy, FlashAttentionTriton
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return DDPWrapper(module, bucket_size_mb * 1024 ** 2)
